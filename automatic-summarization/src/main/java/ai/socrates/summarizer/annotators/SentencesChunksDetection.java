...
//
		...
		while (sentIterator.hasNext()){
			...
			isDependent=isDependent || sentenceTextLowercased.matches("(but|therefore|then|ironically|his|her|their|these|other|he|she|it|they|this|for example|specifically)\\b.*");
