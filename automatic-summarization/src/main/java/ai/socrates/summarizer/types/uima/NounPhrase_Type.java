...
public class NounPhrase_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("ai.socrates.summarizer.types.uima.NounPhrase");
  ...
  public int getDomains(int addr) {
      ...
      jcas.throwFeatMissing("domains", "ai.socrates.summarizer.types.uima.NounPhrase");
